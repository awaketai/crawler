...
type CrawlerMasterClient interface {
	...
	DeleteResource(ctx context.Context, in *ResourceSpec, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *crawlerMasterClient) AddResource(ctx context.Context, in *ResourceSpec, opts ...grpc.CallOption) (*NodeSpec, error) {
	out := new(NodeSpec)
	err := c.cc.Invoke(ctx, "/common.CrawlerMaster/AddResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *crawlerMasterClient) DeleteResource(ctx context.Context, in *ResourceSpec, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/common.CrawlerMaster/DeleteResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CrawlerMasterServer interface {
	...
	DeleteResource(context.Context, *ResourceSpec) (*emptypb.Empty, error)
...
func (UnimplementedCrawlerMasterServer) DeleteResource(context.Context, *ResourceSpec) (*emptypb.Empty, error) {
...
func _CrawlerMaster_AddResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/common.CrawlerMaster/AddResource",
	}
...
func _CrawlerMaster_DeleteResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/common.CrawlerMaster/DeleteResource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CrawlerMaster_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "common.CrawlerMaster",
